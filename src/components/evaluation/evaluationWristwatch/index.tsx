        ...
        <article className='calc'>
            <div className="limit">
                <form autoComplete="off" className='form' onSubmit={form.handleSubmit}>
                    ...
                    <Basic name='fullName' label='ПІБ' placeholder="Прізвище, ім'я, по батькові" value={form.values.fullName} form={form}/>
                    <Basic name='nameProduct' label='Назва годинника' placeholder='Виробник, модель годинника' value={form.values.nameProduct} form={form}/>
                    <Basic name='phone' label='Ваш номер телефону' placeholder='+380' number={true} value={form.values.phone+''} form={form}/>
