    ...
    return (
        <div className="descriptionText">
            <div className="limit">
                ...
                <p>
                    А для максимального зручності, наш особистий кабінет дозволяє вам легко переглядати та сплачувати кредити, вести контроль над вашими фінансами та виконувати всі необхідні операції в режимі онлайн.
                </p>
