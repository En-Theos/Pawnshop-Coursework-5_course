        ...
        default:
            return (
                <div style={{
                    ...
                    <Title minorTitle={{ text: "" }} mainTitle={{ text: "Реєстрація" }} />
                    <Formik
                        initialValues={{
                            name: '',
                            email: '',
                        ...
                        {({ setFieldValue, errors, values }) => (
                            <Form>
                                ...
                                <div className='field'>
                                    ...
                                    <Field className='input' type="password" name="repeatPassword" />
                                    <ErrorMessage name={'repeatPassword'} render={(message) => {
                                        return (
                                            <p className='errorMessage'>{message}</p>
                                        )
                                    }} />
                                ...
                                <div className='field' style={{ margin: "0 auto", width: "fit-content" }}>
                                    <button
                                        disabled={!!(errors.name || errors.email || errors.password || errors.repeatPassword) || !(values.name || values.email || values.password || values.repeatPassword)}
                                        type='submit'
                                    >
                                        Зареєструватись
                                    </button>
