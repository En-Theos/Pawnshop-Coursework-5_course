...
export default function AntiquesPage() {
    return (
        <main className="evaluationPage">
            <Title minorTitle={{ text: "Оцiнка антикварiату" }} mainTitle={{ text: "Надсилайте фото свого годинника нам на оцінку і ми пришлем вам результат чи перезвонимо для додаткової інформації.", size: "20px" }} />
            <EvaluationAntiques/>
