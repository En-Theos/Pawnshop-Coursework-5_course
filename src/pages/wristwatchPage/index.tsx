...
export default function WristwatchPage() {
    return (
        <main className="evaluationPage">
            <Title minorTitle={{ text: "Оцiнка наручних годинникiв" }} mainTitle={{ text: "Надсилайте фото свого годинника нам на оцінку і ми пришлем вам результат чи перезвонимо для додаткової інформації.", size: "20px" }} />
